...
class GrafikEwmpDosenController extends Controller
{
    public function index()
    {
        // Mengambil data yang sudah digroup dan dihitung total kerjasama berdasarkan tahun dan semester
        $data = EwmpDosen::join('tahun_ajaran_semester', 'ewmp_dosen.tahun_ajaran_id', '=', 'tahun_ajaran_semester.id')
            ->select(
        ...
        // Kirim data ke view
        return view('pages.admin.petugas.grafik.data-dosen.ewmp_dosen.index', compact('data'));
    }
}
