...
class GrafikDosenPembimbingController extends Controller
{
    public function index()
    {
        // Mengambil data yang sudah digroup dan dihitung total kerjasama berdasarkan tahun dan semester
        $data = DosenPembimbingTA::join('tahun_ajaran_semester', 'dosen_pembimbing_ta.tahun_ajaran_id', '=', 'tahun_ajaran_semester.id')
            ->select(
        ...
        // Kirim data ke view
        return view('pages.admin.petugas.grafik.data-dosen.dospem_ta.index', compact('data'));
    }
}
