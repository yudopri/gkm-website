...
class GrafikDosenTetapController extends Controller
{
    public function index()
    {
        // Mengambil data yang sudah digroup dan dihitung total kerjasama berdasarkan tahun dan semester
        $data = DosenTetapPT::join('tahun_ajaran_semester', 'dosen_tetap_pt.tahun_ajaran_id', '=', 'tahun_ajaran_semester.id')
            ->select(
        ...
        // Kirim data ke view
        return view('pages.admin.petugas.grafik.data-dosen.dosenTetap_pt.index', compact('data'));
    }
}
