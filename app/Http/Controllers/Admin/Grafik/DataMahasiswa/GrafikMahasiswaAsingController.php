...
class GrafikMahasiswaAsingController extends Controller
{
    public function index()
    {
        // Mengambil data yang sudah digroup dan dihitung total kerjasama berdasarkan tahun dan semester
        $data = MahasiswaAsing::join('tahun_ajaran_semester', 'mahasiswa_asing.tahun_ajaran_id', '=', 'tahun_ajaran_semester.id')
            ->select(
        ...
        // Kirim data ke view
        return view('pages.admin.petugas.grafik.data-mahasiswa.mahasiswa_asing.index', compact('data'));
    }
}
