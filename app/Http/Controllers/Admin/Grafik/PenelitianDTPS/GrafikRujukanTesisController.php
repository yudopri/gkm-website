...
$data = DtpsRujukanTesis::join('tahun_ajaran_semester', 'dtps_rujukan_tesis', '=', 'tahun_ajaran_semester.tahun_ajaran')
->select(
...
->get();
        // Kirim data ke view
        return view('pages.admin.petugas.grafik.kualitas-pembelajaran.rujukan_tesis.index', compact('data'));
    }
}
