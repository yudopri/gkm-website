...
$data = DtpsPenelitianMahasiswa::join('tahun_ajaran_semester', 'dtps_penelitian_mahasiswa', '=', 'tahun_ajaran_semester.tahun_ajaran')
->select(
...
->get();
        // Kirim data ke view
        return view('pages.admin.petugas.grafik.kualitas-pembelajaran.penelitian_mahasiswa.index', compact('data'));
    }
}
