...
class BukuChapterMahasiswaController extends Controller
{
    /**
    ...
    public function index(string $tahunAjaran)
    {
        ...
        $tahun = $tahunAjaranObj->tahun_ajaran;
            $bookChapter = BukuChapterMahasiswa::with('user')->where('tahun', $tahun)->get();
    ...
    {
        try {
            $BukuChapterMahasiswa = new BukuChapterMahasiswa();
            $tahunAjaranObj = TahunAjaranSemester::where('slug', $tahunAjaran)->firstOrFail();
            $tahunAjaranId = $tahunAjaranObj->id;
            $tahun = $tahunAjaranObj->tahun_ajaran;
    ...
    {
        try {
            $dosen = User::with('profile', 'buku_chapter_mahasiswa')->whereId($id)->firstOrFail();

            return view('pages.admin.petugas.luaran-mahasiswa.luaran-lain.buku-chapter.detail', [
                'data_dosen' => $dosen,
                'dosenId' => $dosen->id,
            ]);
        } catch (\Exception $e) {
    ...
    {
        try {
            $buku_chapter = BukuChapterMahasiswa::with('user')->find($id);
            $tahunAjaranObj = TahunAjaranSemester::where('slug', $tahunAjaran)->firstOrFail();
            $tahunAjaranId = $tahunAjaranObj->id;
            $tahun = $tahunAjaranObj->tahun_ajaran;
            return view('pages.admin.luaran-mahasiswa.luaran-lain.buku-chapter.form', [
