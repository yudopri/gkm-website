...
class PkMDtps2Controller extends Controller
{
   /**
    ...
    // 3. Ambil objek tahun ajaran berdasarkan slug
        ...
        $PKMDTPSKeyAliases = [
            'pkm_dtps_mahasiswa' => 'Tabel 6.a PKM DTPS yang Melibatkan Mahasiswa',
        ...
        // 5. Pass ke view
        return view('pages.admin.rekap-data.pkm-dtps-yang-melibatkan-mahasiswa.index', [
