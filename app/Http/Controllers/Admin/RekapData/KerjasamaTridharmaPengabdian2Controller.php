...
class KerjasamaTridharmaPengabdian2Controller extends Controller
{
    /**
    ...
    $tahunAjaranList = TahunAjaranSemester::all()->map(function ($item) {
        ...
        return view('pages.admin.rekap-data.kerjasama-tridharma-pengabdian.index', compact('tahun_ajaran', 'tahunAjaranList'));
    }
