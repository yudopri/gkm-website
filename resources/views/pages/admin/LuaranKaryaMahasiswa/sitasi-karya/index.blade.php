        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <!-- #s btn tambah -->
                        <a href="{{ route('admin.kinerja-dosen.sitasi-karya.create', $tahun_ajaran) }}" class="btn btn-info mb-3">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="dropdown">
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('admin.kinerja-dosen.sitasi-karya.edit', ['sitasiId' => $sitasi->id, 'tahunAjaran' => $tahun_ajaran]) }}">
    <i class="bx bx-edit-alt me-1"></i> Edit
</a>

<form action="{{ route('admin.kinerja-dosen.sitasi-karya.destroy', ['sitasiId' => $sitasi->id, 'tahunAjaran' => $tahun_ajaran]) }}" method="POST" style="display:inline;">
    @csrf
    @method('DELETE')
