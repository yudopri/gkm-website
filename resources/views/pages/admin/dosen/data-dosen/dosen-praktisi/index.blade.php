                                            ...
                                            <td class="text-center">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{ route('admin.data-dosen.dosen-praktisi.edit', $dosen->id) }}">
                                                            <i class="bx bx-edit-alt me-1"></i> Edit
                                                        </a>
                                                        <a class="dropdown-item" href="{{ route('admin.data-dosen.dosen-praktisi.destroy', $dosen->id) }}"
