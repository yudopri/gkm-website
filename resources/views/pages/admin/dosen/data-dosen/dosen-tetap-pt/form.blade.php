            ...
            <div class="col-md-12">
                ...
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Data Dosen | Dosen Tetap Perguruan Tinggi </h5>
                    ...
                    <div class="card-body">
                        <form action="{{ $form_action }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nidn" name="nidn_nidk"
                                        value="{{ old('nidn_nidk', $dosen->nidn_nidk) }}" required />
                                </div>
                            </div>

                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="pascaMagister">
                                    Pendidikan Pasca Sarjana Magister
                                </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="pascaMagister" name="gelar_magister"
                                        value="{{ old('gelar_magister', $dosen->gelar_magister) }}" />
                                </div>
                            </div>

                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="pascaDoktor">
                                    Pendidikan Pasca Sarjana Doktor
                                </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="pascaDoktor" name="gelar_doktor"
                                        value="{{ old('gelar_doktor', $dosen->gelar_doktor) }}" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="kesesuaianKompetensi">Kesesuaian dengan Kompetensi Inti PS</label>
                                <div class="col-sm-10 d-flex align-items-center">
                                    <input class="form-check-input" type="checkbox" id="kesesuaianKompetensi" name="kesesuaian_kompetensi" value="1"
                                        {{ old('kesesuaian_kompetensi', $dosen->kesesuaian_kompetensi ?? false) ? 'checked' : '' }} />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" id="jabatanAkademik" name="jabatan_akademik" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 d-flex align-items-center">
                                    <input class="form-check-input" type="checkbox" id="kesesuaianKeahlian" name="kesesuaian_keahlian_mk"
                                        value="1" {{ old('kesesuaian_keahlian_mk', $dosen->kesesuaian_keahlian_mk ?? false) ? 'checked' : '' }} />
                                </div>
                            </div>

                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="matkulDiampuLain">
                                    Mata Kuliah yang Diampu pada PS Lain
                                </label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="matkulDiampuLain" name="mk_ps_lain">{{ old('mk_ps_lain', $dosen->mk_ps_lain) }}</textarea>
                                </div>
                            </div>
