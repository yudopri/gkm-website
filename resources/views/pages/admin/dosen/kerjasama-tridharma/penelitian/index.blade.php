        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <!-- #s btn tambah -->
                        <a href="{{ route('admin.dosen.kt.penelitian.create', $tahun_ajaran) }}" class="btn btn-info mb-3">
                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody class="table-border-bottom-0">
                                    @forelse ($kerjasama_penelitian as $kerjasama)
                                        <tr>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.dosen.kt.penelitian.edit', ['tahunAjaran' => $tahun_ajaran, 'penelitianId' => $kerjasama->id]) }}">
                                                            <i class="bx bx-edit-alt me-1"></i> Edit
                                                        </a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.dosen.kt.penelitian.destroy', ['tahunAjaran' => $tahun_ajaran, 'penelitianId' => $kerjasama->id]) }}"
