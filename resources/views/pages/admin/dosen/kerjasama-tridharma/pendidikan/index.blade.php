    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card mb-4">
                    <h5 class="card-header">Tabel Kerjasama Pendidikan</h5>
                    <hr class="my-0" />
                    <div class="card-body">
                        <!-- #s btn tambah -->
                        <a href="{{ route('admin.dosen.kt.pendidikan.create', $tahun_ajaran) }}" class="btn btn-info mb-3">
                        ...
                        <div class="table-responsive text-nowrap mb-3">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody class="table-border-bottom-0">
                                    @forelse ($kerjasama_pendidikan as $kerjasama)
                                        <tr>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.dosen.kt.pendidikan.edit', ['tahunAjaran' => $tahun_ajaran, 'pendidikanId' => $kerjasama->id]) }}">
                                                            <i class="bx bx-edit-alt me-1"></i> Edit
                                                        </a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.dosen.kt.pendidikan.destroy', ['tahunAjaran' => $tahun_ajaran, 'pendidikanId' => $kerjasama->id]) }}"
