...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            ...
            <span class="text-muted fw-light">Pengakuan/penelitian mahasiswa DTPS /</span>
            {{ $form_title }}
        </h4>
            ...
            <div class="col-md-12">
                ...
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Kinerja Dosen | Pengakuan/penelitian mahasiswa DTPS </h5>
                    ...
                    <div class="card-body">
                        <form action="{{ $form_action }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="namaDosen" name="nama_dosen"
                                        value="{{ old('nama_dosen', $penelitian_mahasiswa->nama_dosen) }}" autofocus required />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="tema_penelitian" name="tema_penelitian"
                                        value="{{ old('tema_penelitian', $penelitian_mahasiswa->tema_penelitian) }}" autofocus required />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nama_mahasiswa" name="nama_mahasiswa"
                                        value="{{ old('nama_mahasiswa', $penelitian_mahasiswa->nama_mahasiswa) }}" placeholder="keahlian1, keahlian2, dst."
                                        required />
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="judul" name="judul"
                                        value="{{ old('judul', $penelitian_mahasiswa->judul) }}" autofocus required />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="Tahun" name="tahun" value="{{ old('tahun', $penelitian_mahasiswa->tahun)}}"
                                        required />
                                </div>
                            </div>
