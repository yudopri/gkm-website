        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <!-- #s btn tambah -->
                        <a href="{{ route('admin.luaran-mahasiswa.luaran-lain.teknologi-karya.create', $tahun_ajaran) }}" class="btn btn-info mb-3">
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{ route('admin.luaran-mahasiswa.luaran-lain.teknologi-karya.edit', ['tahunAjaran' => $tahun_ajaran, 'karyaId' => $karya->id]) }}">
                                                        <i class="bx bx-edit-alt me-1"></i> Edit
                                                    </a>

                                                    <form action="{{ route('admin.luaran-mahasiswa.luaran-lain.teknologi-karya.destroy', ['tahunAjaran' => $tahun_ajaran, 'karyaId' => $karya->id]) }}" method="POST" style="display:inline;">
                                                        @csrf
                                                        @method('DELETE')
